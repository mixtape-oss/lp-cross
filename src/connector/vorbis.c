...
CONNECTOR_EXPORT jlong JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_create(JNIEnv *jni, jobject me) {
...
CONNECTOR_EXPORT jint JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_initialise(JNIEnv *jni, jobject me,
...
CONNECTOR_EXPORT jint JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_getChannelCount(JNIEnv *jni, jobject me, jlong instance) {
	vorbis_state_t* state = (vorbis_state_t*) instance;
	return state->info.channels;
}

CONNECTOR_EXPORT jint JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_input(JNIEnv *jni, jobject me, jlong instance, jobject direct_buffer, jint offset, jint length) {
	vorbis_state_t* state = (vorbis_state_t*) instance;
	ogg_packet packet;
...
CONNECTOR_EXPORT jint JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_output(JNIEnv *jni, jobject me, jlong instance, jobjectArray channels, jint length) {
	vorbis_state_t* state = (vorbis_state_t*) instance;
	float** buffers;
...
CONNECTOR_EXPORT void JNICALL Java_lavaplayer_natives_vorbis_VorbisDecoderLibrary_destroy(JNIEnv *jni, jobject me, jlong instance) {
	vorbis_state_t* state = (vorbis_state_t*) instance;
